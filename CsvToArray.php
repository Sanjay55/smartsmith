...
<?php
/**
 * Convert a CSV file into an associated array.
 ...
 * @return array
 */
function csv_to_array($filename='file.csv',  $header_exist=true, $delimiter=",")
{
	$debug = false;
	...
	if($debug)
	{
		echo "<br>[DEBUG Output Array]<br>";
		echo '<pre>';
		print_r(($data));
		echo '</pre>';
		echo "<br>[DEBUG Output Data End]<br>";
	}
